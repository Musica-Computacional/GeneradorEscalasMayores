...
def welcome():
    ...
    print("Para generar tu escala MAYOR debes ingresar el nombre de una nota cualquiera en notación americana (C,D,E,F,G,A,B) --> (DO,RE,MI,FA,SOL,LA,SI)")
    ...
    print("------------------------------------------------------------------------------------------ ")
    print("Lista de las 12 escalas mayores: 'C','C#','D','D#','E','F','F#','G','G#','A','A#','B'  ")
    print("Posibles combinaciones de acordes: 'D','Dm','D#m','Dbm'... para el acorde de RE o D. ")
    print("------------------------------------------------------------------------------------------ ")
    print()
